...
import net.mindcraft.core.agent.AgentLogger;
import net.mindcraft.core.agent.AgentResponse;
...
public final class ChatSession {
    ...
    private static final Logger LOG = Logger.getLogger("net.mindcraft.core.memory.ChatSession");
